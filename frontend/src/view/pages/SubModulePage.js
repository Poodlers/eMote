...
class SubModulePage extends React.Component {
  ...
  componentDidMount() {
    ...
    repository
      .getPageContent(
        this.props.router.params.moduleNumber,
        this.props.router.params.submoduleNumber,
        this.props.router.params.pageNumber
      )
      .then((response) => {
        if (response.isBlocked) {
          this.setState({ componentState: ComponentState.NOT_ALLOWED });
          return;
        }
        ...
        this.setState({ pageContent: response });
        ...
        for (let i = 0; i < response.exerciciosFavoritos.length; i++) {
          exerciseIsFavorite =
            response.exerciciosFavoritos[i].exercicioIsFavorite;
          type =
            response.exerciciosFavoritos[0].exercicioFile == undefined
              ? "text"
              : response.exerciciosFavoritos[0].exercicioFile.split(".")[1] ===
                "mp4"
              ? "video"
              : "audio";
        }
  ...
  componentDidUpdate(prevProps, prevState) {
    if (
      prevProps.router.params.moduleNumber !=
        this.props.router.params.moduleNumber ||
      prevProps.router.params.submoduleNumber !=
        this.props.router.params.submoduleNumber ||
    ...
    const repository = RepositorySingleton.getInstance().injectRepository();
    if (
      prevState.moduleNumber != this.state.moduleNumber ||
        ...
        .then((response) => {
          ...
          for (let i = 0; i < response.exerciciosFavoritos.length; i++) {
            ...
            type =
              response.exerciciosFavoritos[0].exercicioFile == undefined
                ? "text"
                : response.exerciciosFavoritos[0].exercicioFile.split(
                    "."
                  )[1] === "mp4"
                ? "video"
                : "audio";
    ...
    return (
      <>
        ...
        {this.state.componentState == ComponentState.NOT_ALLOWED ? (
          <Typography
            color="secondary"
            sx={{ fontWeight: "bold", p: 0.5, ml: "10px" }}
          >
          ...
          <>
            <Box
              sx={{
                backgroundColor: this.state.module.color2,
                height: "100vh",
              }}
            >
              ...
              <AppBar
                sx={{
                  ...
                  top: "60px",
                  height: "100px",
                  backgroundColor: this.state.module.color1,
                }}
              >
              ...
              >
                <Box
                  sx={{ pt: 1, backgroundColor: this.state.module.color2 }}
                  textAlign="center"
                >
                  <SubmoduleContentPage
                    ...
                    isLastPage={this.state.pageContent.isLastPage}
                    isModuleEnd={this.state.pageContent.isLastPageInModulo}
                    module={this.state.module}
                    pageNumber={this.state.pageNumber}
                    subModuleNumber={this.state.submoduleNumber}
                    submodulesContent={this.state.pageContent.subModulePage}
                  />
                  {this.state.pageContent.subModulePage.exercicios.map(
                    (data, index) => {
                      return (
                        <div key={index}>
                          <Box sx={{ pt: 1 }}>
                            <Typography
                              ...
                              variant="body1"
                              color={
                                this.state.module.moduloId == 4
                                  ? this.state.module.color1
                                  : "white"
                              }
                            >
                              {data.exercicioName}
                          ...
                          <Box sx={{ p: 3 }}>
                            ...
                            this.state.videoIsLoading ? (
                              <Typography
                                color={
                                  this.state.module.theme === "blue"
                                    ? this.state.module.color1
                                    : "black"
                                }
                                sx={{ p: 1, pl: 2.5, pt: 2.5, fontSize: 20 }}
                                variant="body1"
                              >
                                Carregando o vídeo...
                              </Typography>
                            ...
                            <Grid container direction="column">
                              {this.state.type === "text" ? (
                                ...
                                <ReactPlayer
                                  ...
                                  style={{
                                    margin: "0 auto",
                                    display: this.state.videoIsLoading
                                      ? "none"
                                      : "block",
                                  }}
                                ...
                                <>
                                  <Grid item alignSelf={"center"}>
                                    <img
                                      alt="phones"
                                      src={
                                        this.state.module.theme === "green"
                                          ? phonesGreen
                                          : this.state.module.theme === "purple"
                                          ? phonesPurple
                                          : phonesBlue
                                      }
                                    />
                                  </Grid>
                                  <Grid item m={0} alignSelf={"center"}>
                                    <AudioPlayer
                                      style={{
                                        backgroundColor:
                                          this.state.module.color1,
                              ...
                              <Grid item m={2} alignSelf={"center"}>
                                ...
                                >
                                  {this.state.exerciseIsFavorite ? (
                                    <FavoriteIcon
                                      sx={{ fontSize: 60 }}
                                      htmlColor={this.state.module.color1}
                                    />
                                  ) : (
                                    <FavoriteBorderIcon
                                      sx={{ fontSize: 60 }}
                                ...
                                <Typography
                                  ...
                                  variant="body1"
                                  color={this.state.module.color1}
                                >
                                  Favoritos
                                </Typography>
                              </Grid>
                ...
                !this.state.pageContent.isLastPage ? (
                  <Button
                    onClick={this.handleEndOfPage}
                    sx={{
                      bottom: "5%",
                      left: "60%",
                      backgroundColor: this.state.module.color1,
                      "&:hover": { backgroundColor: this.state.module.color3 },
                    }}
                    variant="contained"
