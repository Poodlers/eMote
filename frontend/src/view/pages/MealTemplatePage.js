...
import CompanySlider from '../widgets/MealDiary/CompanySlider';
...
const errorMessagesText = {
    ...
    CompanyAroundMeal: 'Por favor, indique a companhia que tiveste durante esta refeição',
  ...
  const submitMealDiary = () => {
        ...
        const foodDiary = 
            ...
            } : 
            {
                ...
                companyAroundMeal : companyAroundMeal,
    ...
    const [companyAroundMeal, setCompanyAroundMeal] = React.useState([]);
    ...
    useEffect(() => {
        repository.checkIfMealDiaryIsAlreadyAdded(mealEnum).then((response) => {
            ...
            if(!response){
                ...
                setCompanyAroundMeal(response.companyAroundMeal);
        ...
        <Box sx= {{backgroundColor: '#01698b', height:'100vh', mt:0}}>
            ...
            <Box sx={{p:2}}>
                ...
                {skippedMeal ? null : <div> 
                    ...
                    <CompanySlider initialValue = {companyAroundMeal} canEdit={!hasAlreadyFilled} setCompany={setCompanyAroundMeal} mainColor = '#01688a' />
