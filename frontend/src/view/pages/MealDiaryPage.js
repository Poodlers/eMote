...
function MealDiaryPage() {
  return (
        ...
        <IconButton component={Link} to="/" aria-label="back" size="large">
            ...
            <Typography gutterBottom sx={{ pb:1, textAlign: 'center', fontSize: 17, fontWeight: 500 }} variant='body1' color={"primary"}>
          ...
          <Box sx={{p:2}}>
            ...
            <MealButton meal= "Lanche da Tarde" href="/lanchetarde" />
